import ironBox from "../assets/foldedClothes.png"

export default function About(){    
    return(
        <div className="flex flex-col md:justify-center items-center md:my-28 font-DMSans">
            ...
            <div className="flex p-4 flex-col-reverse md:flex-row justify-center items-center gap-4 md:px-20 py-8">
                <img src={ironBox} alt="iron box" className="ml-8 mt-4 md:ml-0 md:mt-0"  />
